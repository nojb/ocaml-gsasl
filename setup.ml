...
(* OASIS_START *)
(* DO NOT EDIT (digest: ab948da8491d996229565b3b0559c933) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/nojb/ocaml-gsasl";
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gsasl_genstubs.ml"});
               Library
                 ({
                     cs_name = "gsasl";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [
                           ...
                           InternalExecutable "gsasl_genstubs"
                        ];
                      bs_c_sources = ["gsasl_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true,
                             ["-I"; "${pkg_ctypes}/.."; "-I"; "${pkg_ctypes}"
                             ])
                        ];
                      bs_cclib = [(OASISExpr.EBool true, ["-lgsasl"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Gsasl_bindings"; "Gsasl_generated"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "V\151\019U\002F4\205\242\002\023\158\"\139\226\232";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
